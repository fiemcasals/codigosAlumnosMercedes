# Juego de piedra papel o tijera, donde el usuario juega contra la computadora. Elige una opción (1, 2 o 3 respectivamente) y compite contra la IA. Al mejor de 3 rondas, se determina el ganador final.
import random
